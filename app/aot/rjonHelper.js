...
exports.statIconMap = statIconMap_1.statIconMap;
        ...
        if (route.status) {
            if (route.status.forEach) {
                route.status.forEach(function (status) {
                    return output += statIconMap_2.statIconMap[status].icon ? statIconMap_2.statIconMap[status].icon : status;
                });
            }
            else {
                output += statIconMap_2.statIconMap[route.status].icon ? statIconMap_2.statIconMap[route.status].icon : route.status;
            }
        }
        output += '|\n';
    }
